...
public class FamilyMemberResourceTest extends TestResourceBase {
    ...
    public void get() throws Exception {
        ...
        when(familyMemberDAO.getFamilyMember(9999L, 1337L)).thenReturn(familyMember);
    ...
    public void put() throws Exception {
        ...
        verify(familyMemberDAO).updateFamilyMember(eq(9999L),eq(1337L), any(FamilyMember.class));
    ...
    public void delete() throws Exception {
        ...
        verify(familyMemberDAO).deleteFamilyMember(9999L,1337);
    ...
    public void getFamiliesWillReturnFamilyList(){
        ...
        when(familyMemberDAO.getFamilyMembers(9999L)).thenReturn(familyMemberList);
